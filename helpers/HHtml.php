...
class HHtml{
	...
	public static function jsInline($content,$attributes=array()){
...
//]]>
	...
	public static function ganalytics($code){
		return '<script type="text/javascript">
var _gaq=_gaq || [];_gaq.push(["_setAccount","'.$code.'"]); _gaq.push([\'_trackPageview\']);
(function(){
