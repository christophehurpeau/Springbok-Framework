...
$.each(console,function(k,v){
	var f=window.console[k];
	window.console[k]=function(){oldConsoleVar&&oldConsoleVar[k]&&oldConsoleVar[k].apply(oldConsoleVar,arguments);f.apply(window.console,arguments);};
});
