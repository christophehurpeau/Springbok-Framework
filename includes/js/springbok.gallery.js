function Gallery(to,albumLink,imageLink,onSelectImage,imageAttrs){
	...
	t.$.html('')
		...
		.append($('<div/>').addClass('align_right')
	...
	var uploader=t.prepareUploader({
		...
		onFileUploaded:function(file,response,resp){
			...
			if(error){
				...
				var image={id:response.id,name:file.name,created:new Date().toSqlDate()},
...
Gallery.prototype.setOnSelectImage=function(callback){this.onSelectImage=callback;};
...
Gallery.prototype._addItem=function(li,animate,type,idxOf){
	if(animate){
...
Gallery.prototype.addImage=function(image,animate,idxOf){
...
Gallery.prototype.image=function(id){
...
Gallery.prototype.addAlbum=function(album,animate,idxOf){
...
Gallery.prototype.addBreadcrumb=function(album){
...
Gallery.prototype.prepareUploader=function(options){
